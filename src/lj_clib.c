...
extern void *clib_loadlib(lua_State *L, const char *name, int global);

extern void clib_unloadlib(CLibrary *cl);

extern void *clib_getsym(CLibrary *cl, const char *name);
